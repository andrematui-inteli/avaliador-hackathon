...
function gerarFeedbackQualitativo_(textoProjeto, criteriaText, projectName, groupName) {
  var prompt = [
    ...
    '- Os critérios acima podem conter pesos, faixas de pontuação e escalas de uso interno',
    '  da organização do evento. NUNCA cite, reproduza ou faça referência a esses números,',
    '  nem indique em que faixa ou posição o projeto se encontra.',
